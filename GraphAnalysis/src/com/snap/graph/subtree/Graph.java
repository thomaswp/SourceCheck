...
public class Graph<N,E> {
	...
	protected final HashMap<N, List<Edge>> fromMap = new HashMap<N, List<Edge>>();
	protected final HashMap<N, List<Edge>> toMap = new HashMap<N, List<Edge>>();
	protected HashMap<N, Vertex> vertexMap = new HashMap<N, Vertex>();
